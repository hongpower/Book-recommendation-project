        ...
        # 작가가 여러명이거나 번역가가 있는 경우 :
            ...
            for person in authors:
                ...
                if identity == "author":
                    ...
                    ## author_info
                    temp_info = person.find('authorInfo').string
...
for i in range(0,160000, 10000):
    ...
    # final_list : 매번 업데이트가 된다 (만번마다)
    # new_books : 이전꺼에다가 append한다 (10000만번마다 리셋되지만 누적)
    # temp_books : new_books에서 중복값 삭제와 정렬을 한 리스트
