...
url = "https://www.aladin.co.kr/shop/wbrowse.aspx?BrowseTarget=List&ViewRowsCount=1000&ViewType=Detail&PublishMonth=0&SortOrder=6&page=1&Stockstatus=1&PublishDay=84&CID=55889&CustReviewRankStart=&CustReviewRankEnd=&CustReviewCountStart=&CustReviewCountEnd=&PriceFilterMin=&PriceFilterMax=&SearchOption="
driver.get(url)
...
while True:
    ...
    for j in range(page_length-1, -1, -1):
        ...
        for book in reversed(result):
            ...
            if review_cnt != None:
                try:
                    temp['review_cnt'] = int(review_cnt.text.strip(' ('))
                except:
                    pass
...
with open('../data/all_essay_ids.json', 'w', encoding='utf-8') as f:
    f.write(json_dict)
