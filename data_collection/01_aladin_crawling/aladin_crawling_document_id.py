...
url = "https://www.aladin.co.kr/shop/wbrowse.aspx?BrowseTarget=List&ViewRowsCount=1000&ViewType=Detail&PublishMonth=0&SortOrder=6&page=1&Stockstatus=1&PublishDay=84&CID=336&CustReviewRankStart=&CustReviewRankEnd=&CustReviewCountStart=&CustReviewCountEnd=&PriceFilterMin=&PriceFilterMax=&SearchOption="
driver.get(url)

## 모든 책에 대한 정보 크롤링하기(국내도서-자기계발에서 등록일 순으로 정렬한 후에 모든 책 크롤링)
...
with open('../data/all_document_ids.json', 'w', encoding='utf-8') as f:
    f.write(json_dict)
