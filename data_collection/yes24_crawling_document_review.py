...
isbn_path = "/Users/jisu/Desktop/project/book_recommendation_project/data/"
isbn_file_name = "document_isbn.json"
...
for isbn in isbn_lst[5149:5500]:
    print(isbn)
    sleep(0.5)
    memory_cnt += 1
...
with open('yes24_reviews/yes24_document_reviews_5149_5500.json', 'w') as f:
