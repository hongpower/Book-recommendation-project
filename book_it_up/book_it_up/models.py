...
# haystack searchindex 생성 :
# 1) book model과 상응하는 bookIndex생성하자 -> search_indexes.py file에 작성한다
...
class BookGrade(models.Model):
    book = models.OneToOneField(Book, models.DO_NOTHING, primary_key=True, related_name='grade')
...
class BookHistory(models.Model):
    history_id = models.CharField(primary_key=True, max_length=20)
